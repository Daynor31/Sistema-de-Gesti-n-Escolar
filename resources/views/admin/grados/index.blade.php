...
@section('content')
    <div class="row">
        <div class="col-md-10"> {{-- Aumenté un poco el ancho para que la tabla no se vea apretada --}}
                                    ...
                                    <td>
                                        @foreach ($nivel->grados as $grado)
                                            <div class="row justify-content-center d-flex mb-1">
                                                ...
                                                {{-- CORRECCIÓN: Ruta cambiada de periodos a grados --}}
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group text-left">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                {{-- CORRECCIÓN: Se cambió $periodo->nombre por $grado->nombre --}}
